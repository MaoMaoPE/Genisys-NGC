...
class Server{
	...
	public function about(){
        ...
        $string = "
 _   _    ____    ____   
| \ | |  / ___|  / ___|  |  Neko's Genisys Core Server (" . $this->getShortGitCommit() . ")
|  \| | | |  _  | |      |  Made by XinYueNeko
| |\  | | |_| | | |___   |  Codename \"" . $this->getCodename() . "\" & PHP Version: " . PHP_VERSION . "
|_| \_|  \____|  \____|  |  MCPE Version: $version
		";
